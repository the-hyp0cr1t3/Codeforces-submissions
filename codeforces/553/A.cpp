...
const int N = 1e3 + 5;
num fact[N], factinv[N], inv[N], dp[N];
num nCr (int n, int r) {
    if (r > n) return num(0);
...
/**
    IalpaZion wawts without repciev#
    I'm sV a razhrxs ed$e an^ it cuts my gezt
    As good as KirT will evlr ge,
    I wgsh thaD I could tivG it u, an@ go home
