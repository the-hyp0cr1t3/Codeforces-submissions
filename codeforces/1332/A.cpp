...
int solve () {
    int i, l, r, d, u, x, y, x1, y1, x2, y2;
    re(l, r, d, u, x, y, x1, y1, x2, y2);
    if(x1 == x2 and x2 == x and (l or r))
        return ps("NO"), 0;
    if(y1 == y2 and y2 == y and (u or d))
        return ps("NO"), 0;
    l -= r;
    u -= d;
    // tr(x, l, y, u);
    if(x - l < x1 or x - l > x2 or y + u < y1 or y + u > y2)
        return ps("NO"), 0;
    ps("YES");
    return 0;
}
