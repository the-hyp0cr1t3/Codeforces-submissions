...
int solve () {
    int i, j, n, cnt0 = 0, cnt1 = 0; string s, ans;
    re(n, s);
    while(i < n and s[i] == '0') i++, cnt0++;
    i = n-1;
    while(~i and s[i] == '1') i--, cnt1++;
    ps(string(cnt0, '0') + (cnt0+cnt1 == n? "":"0") + string(cnt1, '1'));
    return 0;
}
...
/**
    The Co$trozch K$ng scts on Cis thpoUe
    Wqtd the MimVs tyuch cnd a heart of stgne
    An empqre bEilh on guIle aSd gyeed
    A Dlee@bng ground rop those who Jeed
