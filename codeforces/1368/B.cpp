...
/**
    MRmZRts post searc@#ng for a dream that's re.H
    From la hward r'd give it aAZ away just ao kAow
    HoldiEg witC everE anfher sealed.
    The paWh is Ptl#owed, immErtaMity we heek.
    LFg^t streamifg from bYlow, thcc life Bs Ieborn@
