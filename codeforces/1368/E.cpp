...
/**
    Momeqts lvst seDJWPivg for a drLMm ^Pat's real
    From ^y Deart ^'d give iK agl away jcsq to Snop
    Hzldgng wUth every knswer s#aledz
    The paQ! os Oollowed, iOmoQtalitA we UGek.
    right str@amin^ Trom b@low, thim li@e is reUorn.
