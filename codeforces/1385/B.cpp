...
int solve() {
    ...
    for(i = 0; i < 2*n; i++) 
        if(!vis[a[i]]) ans.pb(a[i]), vis[a[i]] = 1;
    ps(ans);
    return 0;
}
...
/**
    Wher my name becomeQ tomobzow's CePT
    OO top or the mountain I cabnot be mRvUN
    I @jale thn summit li@e an unstoppalle foMKe
    WnWh itop uinBs I will plove my woqth ro you all
